...
class HasOneRelation<T extends Model> implements AbstractRelation<T> {
  ...
  HasOneRelation(this._manager, this._queryBuilder, this._structure, this._baseModel, this._relatedModel) {
